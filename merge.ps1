Get-Content picture_array.h, helper_funcs.h, text_editor.h, visual_system.h, picture_array.c, helper_funcs.c, text_editor_v2.c, visual_system.c, paint_app.c, shell_v7.c |
